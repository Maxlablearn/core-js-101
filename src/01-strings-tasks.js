...
function encodeToRot13(str) {
  ...
  return str.replace(/[a-z]/gi, (sumbol) => alpha[rot13.indexOf(sumbol)]);
}
...
function isString(value) {
  let result = true;
  try {
    // eslint-disable-next-line no-proto, no-prototype-builtins
    result = value.__proto__.hasOwnProperty('toUpperCase');
  } catch (e) {
    result = false;
  }
  return result;
